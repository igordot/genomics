...
subtitle: "HDCyto workflow step 1"
...
It generates `input/metadata-files.csv` and `input/metadata-channels.csv` metadata tables which should be manually edited to clean up labels, define sample groups, and specify the relevant samples and markers/antibodies used for the next step (`hdcyto-2-prepare-sce.qmd`).
